...
export declare const catMaybes: <T extends unknown>(array: Array<T | undefined | null>) => Array<T>;
...
export declare const mmap: <I extends unknown, O>(f: (v: I) => O, v?: I | null) => O | undefined | null;
export declare const mthen: <I extends unknown, O>(v: I | undefined | null, f: (v: I) => O | undefined | null) => O | undefined | null;
