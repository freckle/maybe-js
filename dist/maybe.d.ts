...
export declare const catMaybes: <T>(array: Array<T | undefined | null>) => Array<T>;
...
export declare const mmap: <I, O>(f: (v: I) => O, v?: I | null) => O | undefined | null;
export declare const mthen: <I, O>(v: I | undefined | null, f: (v: I) => O | undefined | null) => O | undefined | null;
